...
代码基本风格统一使用 [JavaScript Standard Style](https://standardjs.com/rules-zhcn.html)
...
**注：本文档参考自 https://github.com/ecomfe/spec/blob/master/javascript-style-guide.md ，基于此规范做了部分改动和调整。**
